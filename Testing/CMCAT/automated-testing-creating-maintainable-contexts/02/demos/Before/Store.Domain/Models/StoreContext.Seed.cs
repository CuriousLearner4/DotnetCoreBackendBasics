...
namespace Store.Domain.Models
{
    public partial class StoreContext
    {
        ...
        private static void SeedCountryTable(ModelBuilder modelBuilder)
        {
            var data = new[]
            {
                new Country { Id = 1, Abbreviation = "USA", Name = "The United States of America", Description = "The United States of America" , PostalCodeLabel = "Zip Code",StateLabel = "State"},
                new Country { Id = 2, Abbreviation = "CAN", Name = "Canada", Description = "Canada", PostalCodeLabel = "Posta lCode",StateLabel = "Province/Territory" }
            };
