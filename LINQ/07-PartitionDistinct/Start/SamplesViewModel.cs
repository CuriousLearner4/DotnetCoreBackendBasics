...
namespace LINQSamples
{
    public class SamplesViewModel : ViewModelBase
    {
        ...
        public List<Product> TakeRangeQuery()
        {
            ...
            //
            // Write Query Syntax Here
            list = (from prod in products select prod).Take(5..8).ToList();
        ...
        public List<Product> TakeWhileQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in products orderby prod.Name select prod).TakeWhile(p => p.Name.StartsWith("S")).ToList();
        ...
        public List<Product> TakeWhileMethod()
        {
            ...
            list = products.OrderBy(p => p.Name).TakeWhile(p=>p.Name.StartsWith("S")).ToList();
        ...
        public List<Product> SkipQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in products select prod).Skip(30).ToList();
        ...
        public List<Product> SkipWhileQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from p in products select p).SkipWhile(p => p.Name.StartsWith("S")).ToList();
        ...
        public List<Product> SkipWhileMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.SkipWhile(p => p.Name.StartsWith("S")).ToList();
