namespace LINQSamples
{
    public class SamplesViewModel : ViewModelBase
    {
        ...
        public Product FirstQuery()
        {
            ...
            value = (from p in products select p).First(p => p.Color == "Red");
            // Test the exception handling
            //value = (from p in products select p).First(p => p.Color == "maroon");//it throws an invalid operation exception
            return value;
        }
        #endregion
        ...
        public Product FirstMethod()
        {
            ...
            Product value = products.First(p => p.Color == "Red");
            return value;
        }
        #endregion
        ...
        public Product FirstOrDefaultQuery()
        {
            ...
            // Write Query Syntax Here
            value = (from p in products select p).FirstOrDefault(p=>p.Color=="Red");
        ...
        public Product FirstOrDefaultWithDefaultQuery()
        {
            ...
            // Write Query Syntax Here
            //value = (from prod in products select prod).FirstOrDefault(p=>p.Color == "Red");
            // Test the exception handling
            value = (from prod in products select prod).FirstOrDefault(p => p.Color == "Purple",new Product { ProductID = -1, Name = "Not Found"}); 
            //return null as purple is not present
            return value;
        }
        #endregion
        ...
        public Product FirstOrDefaultWithDefaultMethod()
        {
            ...
            Product value = null;
            // Write Method Syntax Here
            value = products.FirstOrDefault(p => p.Color == "Red",new Product(){ ProductID = -1,Name = "Not Found"});
            return value;
        }
        #endregion
        ...
        public Product LastQuery()
        {
            ...
            // Test the exception handling
            value = (from p in products select p).Last(p => p.Color == "Purple");
            return value;
        }
        #endregion
        ...
        public Product LastOrDefaultQuery()
        {
            ...
            value = (from p in products select p).LastOrDefault(p => p.Color == "Red");
            // Test the exception handling
        ...
        public Product SingleQuery()
        {
            ...
            //value = (from p in products select p).Single(p => p.Color == "Purple");
            return value;
        }
        #endregion
        ...
        public Product SingleMethod()
        {
            ...
            // Write Method Syntax Here
            value = products.Single(p => p.Color == "Red");
            return value;
        }
        #endregion
        ...
        public Product SingleOrDefaultMethod()
        {
            ...
            // Write Method Syntax Here
            value = products.SingleOrDefault(p => p.Color == "Red", new Product { ProductID = -1, Name = "Not FOund" });
