namespace LINQSamples
{
    public class SamplesViewModel : ViewModelBase
    {
        ...
        public bool AllQuery()
        {
            ...
            value = (from prod in products select prod).All(p => p.Color == "Red");
        ...
        public bool AllMethod()
        {
            ...
            value = products.All(p => p.Color == "Red");
        ...
        public bool AnyQuery()
        {
            ...
            // Write Query Syntax Here
            value = (from sale in sales select sale).Any(sale => sale.LineTotal >= 5000);
        ...
        public bool AnyMethod()
        {
            ...
            // Write Method Syntax Here
            value = sales.Any(sale => sale.LineTotal > 0);
