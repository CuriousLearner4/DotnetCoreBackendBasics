    ...
    public class SamplesViewModel : ViewModelBase
    {
            ...
            List<Product> list2 = new()
      {
        ...
        public bool SequenceEqualUsingComparerQuery()
        {
            ...
            // Write Query Syntax Here
            value = (from item in list1 select item).SequenceEqual(list2, pc);
        ...
        public List<Product> ExceptByProductSalesQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from p in products select p).ExceptBy<Product,int>((from sale in sales select sale.ProductID), p => p.ProductID).ToList();
        ...
        public List<Product> ExceptByProductSalesMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.ExceptBy(sales.Select(s => s.ProductID), p => p.ProductID).ToList();
        ...
        public List<int> IntersectIntegersQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from item in list1 select item).Intersect(list2).ToList(); 
        ...
        public List<Product> IntersectUsingComparerQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in list1 select prod).Intersect((from prod in list2 select prod), pc).ToList();
        ...
        public List<Product> IntersectByProductSalesQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in products select prod).IntersectBy((from sale in sales select sale.ProductID), p => p.ProductID).ToList();
        ...
        public List<Product> IntersectByProductSalesMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.IntersectBy(sales.Select(s => s.ProductID), p => p.ProductID).ToList();
