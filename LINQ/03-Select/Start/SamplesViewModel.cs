...
namespace LINQSamples
{
    public class SamplesViewModel : ViewModelBase
    {
        ...
        public List<Product> GetSpecificColumnsQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in products select new Product {ProductID = prod.ProductID,Name = prod.Name,Size = prod.Size}).ToList();
        ...
        public List<Product> GetSpecificColumnsMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.Select(prod => new Product { ProductID=prod.ProductID,Name=prod.Name,Size = prod.Size}).ToList();
        ...
        public string AnonymousClassQuery()
        {
            ...
            // Write Query Syntax Here
            var list = (from prod in products select new { Identifier = prod.ProductID, ProductName = prod.Name, ProductSize = prod.Size });
        ...
        public string AnonymousClassMethod()
        {
            ...
            // Write Method Syntax Here
            var list = products.Select(prod => new { Identifier = prod.ProductID, ProductName = prod.Name, ProductSize = prod.Size });
